...
-- Database: PostgreSQL
-- Generated at: 2024-06-04T06:09:56.818Z
...
ALTER TABLE "account_events" ADD FOREIGN KEY ("account_id") REFERENCES "accounts" ("id");
...
ALTER TABLE "profiles" ADD FOREIGN KEY ("account_id") REFERENCES "profile_events" ("account_id");
...
ALTER TABLE "metadata_events" ADD FOREIGN KEY ("metadata_id") REFERENCES "metadatas" ("id");

ALTER TABLE "metadatas" ADD FOREIGN KEY ("account_id") REFERENCES "accounts" ("id");

ALTER TABLE "stellar_account_events" ADD FOREIGN KEY ("stellar_account_id") REFERENCES "stellar_accounts" ("id");
...
ALTER TABLE "follow_events" ADD FOREIGN KEY ("follow_id") REFERENCES "follows" ("id");
...
ALTER TABLE "account_report_events" ADD FOREIGN KEY ("report_id") REFERENCES "account_reports" ("id");
...
ALTER TABLE "account_moderation_events" ADD FOREIGN KEY ("moderation_id") REFERENCES "account_moderations" ("id");

ALTER TABLE "account_moderations" ADD FOREIGN KEY ("target_id") REFERENCES "accounts" ("id");

ALTER TABLE "account_moderations" ADD FOREIGN KEY ("moderator_id") REFERENCES "moderators" ("stellar_id");
...
ALTER TABLE "stellar_account_moderation_events" ADD FOREIGN KEY ("moderation_id") REFERENCES "stellar_account_moderations" ("id");

ALTER TABLE "stellar_account_moderations" ADD FOREIGN KEY ("target_id") REFERENCES "stellar_accounts" ("id");

ALTER TABLE "stellar_account_moderations" ADD FOREIGN KEY ("moderator_id") REFERENCES "moderators" ("stellar_id");
...
ALTER TABLE "host_moderation_events" ADD FOREIGN KEY ("moderation_id") REFERENCES "host_moderations" ("id");

ALTER TABLE "host_moderations" ADD FOREIGN KEY ("host_id") REFERENCES "stellar_hosts" ("id");

ALTER TABLE "host_moderations" ADD FOREIGN KEY ("moderator_id") REFERENCES "moderators" ("stellar_id");
